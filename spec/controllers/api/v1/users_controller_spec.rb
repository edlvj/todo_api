RSpec.describe Api::V1::UsersController, type: :controller do
  ...
  describe "POST #sign_in" do
    ...
    context "when user enter valid params" do
      let(:valid_params) {{ user: { username: user.username, password: "password"} }}
    ...
    context "when user enter invalid password" do
      let(:invalid_params) {{ user: { username: user.username, password: "qoose"} }}
  ...
  describe "POST #sign_up" do
    context "when user enter valid params" do
      let(:valid_params) {{ user: { username: "daddy", password: "password"} }}
